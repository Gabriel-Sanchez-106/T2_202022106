...
public class Aplicacion {
	...
	public void ejecutarCerrarActual() {
		...
		if (ans==false) {
			...
			nc = null ;
			dc = null ;
			System.out.println("Cerrado y guardado con éxito");
		} else {
			System.out.println("Ya hay un pedido de esta persona");
			int i = Integer.parseInt(input("0-Volver al menú , 1-Guardar igualmente"));
